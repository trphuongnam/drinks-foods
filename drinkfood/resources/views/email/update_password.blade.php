...
<body>
    <div id="wrapper">
        ...
        <p class="content_mail">
            {{ trans('message.fullname') }}: <span class="text_info">{{$infoUpdate['fullname']}}</span> <br>
            {{ trans('message.email') }}: <span class="text_info">{{$infoUpdate['email']}}</span> <br>
            {{ trans('message.password') }}: <span class="text_info">{{$infoUpdate['password']}}</span><br>
